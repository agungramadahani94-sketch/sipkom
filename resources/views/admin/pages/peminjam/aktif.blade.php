...
<section class="section">
    ...
    <div class="section-header justify-content-center">
        <h1 class="font-weight-bold">Peminjaman Aktif</h1>
    </div>
    ...
    <div class="section-body">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header d-flex justify-content-between align-items-center bg-white">
                <h4 class="mb-0">
                    <i class="fas fa-hand-holding text-primary mr-2"></i>
                    Sedang Dipinjam
                </h4>
                <div>
                    <a href="{{ route('peminjam.index') }}" class="btn btn-warning btn-sm mr-1 shadow-sm">
                        <i class="fas fa-clock"></i> Menunggu Approval
                    </a>
                    <a href="{{ route('pengembalian') }}" class="btn btn-success btn-sm shadow-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-primary px-3 py-2">Dipinjam</span>
                                </td>

                                <td class="text-center">

                                    {{-- KEMBALIKAN --}}
                                    <form action="{{ route('peminjam.kembali', $p->id_peminjam) }}" method="POST" class="d-inline">
                                        @csrf
                                    ...
                                    {{-- DELETE --}}
                                    <form action="{{ route('peminjam.destroy', $p->id_peminjam) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
