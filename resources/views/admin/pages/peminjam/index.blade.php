                                ...
                                <tbody>
                                    @forelse($peminjams as $i => $p)
                                        <tr>
                                            ...
                                            <td>{{ $p->tgl_pengembalian ? \Carbon\Carbon::parse($p->tgl_pengembalian)->format('d M Y') : '-' }}
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                {{-- APPROVE --}}
                                                <form action="{{ route('peminjam.approve', $p->id_peminjam) }}" method="POST"
                                                    style="display:inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success btn-sm" Swal.fire({
                                                        icon: 'success' , title: 'Berhasil' , text: 'Peminjaman disetujui' ,
